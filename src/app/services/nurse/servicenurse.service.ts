...
export class ServicenurseService {
  ...
  postData(bp:number,rr:number,temp:number,height:number,weight:number,notes:string,bps:number,bg:string):Observable<any>{
    ...
    return this.http.post("/api/VisitDetails/AddVisitDetails",
    {
  ...
  {
    return this.http.get("/api/Appointment/Get_all_appointment",{headers:this.httpOptions.headers});
  }
  ...
  public getPatientData(data:any):Observable<any>{
    ...
    return this.http.get(`/api/Patient/Get_by_ID/${data}`,{headers:this.httpOptions.headers});
  }
  public getDoctorData(data:any):Observable<any>{
    return this.http.get(`/api/Doctor/particular/${data}`,{headers:this.httpOptions.headers});

  }

  public getMedicalHistory(data:any):Observable<any> {
    return this.http.get(
      `/api/VisitDetails/GetVisitDetailsById/${data}`
    );
  }

  public postAllergy(data:any,id:any):Observable<any>{

    return this.http.post("/api/Allergy/Add",
    {
      "visitId": id,
      "allergyName": data,
      "notes": "none"
  ...
  public postBg(data:any):Observable<any>{
    return this.http.post("/api/Audit/AddBloodGroup",{
  ...
  public postBps(data:any):Observable<any>{
    return this.http.post("/api/Audit/AddBloodPressureSystolic",{
      "patientId": this.myData.patientId,
      "date": this.myData.submissionDate,
      "value": data
    })
  ...
  public postBpd(data:any):Observable<any>{
    return this.http.post("/api/Audit/AddBloodPressureDiastolic",{
      "patientId": this.myData.patientId,
      "date":this.myData.submissionDate,
      "value": data
    })
  ...
  public postTemp(data:any):Observable<any>{
    return this.http.post("/api/Audit/AddBodyTemperature",{
      "patientId": this.myData.patientId,
      "date": this.myData.submissionDate,
      "value": data
    })
  ...
  public postHeight(data:any):Observable<any>{
    return this.http.post("/api/Audit/AddHeight",{
      "patientId": this.myData.patientId,
      "date": this.myData.submissionDate,
      "value": data
    })
  ...
  public postWeight(data:any):Observable<any>{
    return this.http.post("/api/Audit/AddWeight",{
      "patientId": this.myData.patientId,
      "date":this.myData.submissionDate,
      "value": data
    })
  ...
  public postResp(data:any){
    return this.http.post("/api/Audit/AddRespiration",{
      "patientId": this.myData.patientId,
      "date": this.myData.submissionDate,
      "value": data
    })
