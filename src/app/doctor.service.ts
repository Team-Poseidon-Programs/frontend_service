...
export class DoctorService {
  ...
  public GetAppointmentsByAceptanceEmail(id:Number,email:String):Observable<any>{
    const url = `https://52.190.40.95/api/Appointment/AcceptanceAndEmail/${id}/${email}`;
  ...
  public GetPatientDetailsByID(id:Number):Observable<any>{
    const url = `https://52.190.40.95/api/Patient/Get_by_ID/${id}`
    return this.http.get<any>(url);
  }
  ...
  public PutAcceptancebyId(id:Number,Acceptance:Number):Observable<any>{
    const url = `https://52.190.40.95/api/Appointment/updatebyAppointMentNo/${id}/${Acceptance}`;
  ...
  public GetByAcceptanceDoctorEmailDate(AcceptanceNo:number,Date:string,DoctorEmail:string){
    ...
    const url = `https://52.190.40.95/api/Appointment/GetByDateAcceptanceNoDoctorEmail?AcceptanceId=${AcceptanceNo}&Date=${ogDate}&DoctorEmail=${ogDocMail}`;
    return this.http.get<any>(url);
  }

  // https://localhost:7292/poseidonhc/GetVisitDetailsByAcceptanceId/43
  public GetVisitDetailsByAcceptanceId(AcceptanceID:number){
    const url = `https://52.190.40.95/api/VisitDetails/GetVisitDetailsByAcceptanceId/${AcceptanceID}`;
    return this.http.get<any>(url);
  }
  ...
  public GetTestResultsByVisitId(VisitId:number){
    const url = `https://52.190.40.95/api/Test/GetTestListbyid/${VisitId}`
    return this.http.get<any>(url);
  }
  ...
  public PutUpdateTest(TestID:number,TestDetail:TestDetail){
    ...
    const url = `https://52.190.40.95/api/Test/UpdateTest/${TestID}`
  ...
  public DeleteTest(testID:number){
    const url = `https://52.190.40.95/api/Test/DeleteTest/${testID}`
    return this.http.delete<any>(url);
  }

  // /poseidonhc/AddTest
  public AddTest(TestDetails:TestDetail1){
    const url = `https://52.190.40.95/api/Test/AddTest`
  ...
  public ViewPrescription(VisitID:number){
    const url = `https://52.190.40.95/api/Prescription/GetPrescriptionById/${VisitID}`;
    return this.http.get<any>(url);
  }
  // /poseidonhc/AddPrescription

  public AddPriscription(Pres:Prescription){
    const url = `https://52.190.40.95/api/Prescription/AddPrescription`
  ...
  public GetPatientById(patId:number){
    const url = `https://52.190.40.95/api/Patient/Get_by_ID/${patId}`;
    return this.http.get<any>(url);
  }
  ...
  public GetVisitByPatientId(patId:number){
    const url = `https://52.190.40.95/api/VisitDetails/GetVisitDetailsById/${patId}`;
    return this.http.get<any>(url);
  ...
  public EmailSender(Email:string,Status:number){
    const url = `https://52.190.40.95/api/EmailSender/sendEmail/${Email}/${Status}`
  ...
  public GetDoctorDetails(Email:string){
    ...
    const url = `https://52.190.40.95/api/Doctor/particular/${ogDocMail}`;
    return this.http.get<any>(url);
  }
  ...
  public GetDoctorAvailablityByEmail(Email:string){
    const ogDocMail = Email.replace(/@/g,"%40")
    const url = `https://52.190.40.95/api/PhysicianAvailability/FindDoctorByEmailID/${ogDocMail}`;
    return this.http.get<any>(url);
